...
namespace KTANE_Solver
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            //all keypad pictures
            if (!KeypadFileExist("3") || !KeypadFileExist("6") || !KeypadFileExist("A") ||
                !KeypadFileExist("AE") || !KeypadFileExist("B") || !KeypadFileExist("Backwards C") ||
                !KeypadFileExist("Black Star") || !KeypadFileExist("Butt") || !KeypadFileExist("C") ||
                !KeypadFileExist("Copyright") || !KeypadFileExist("E") || !KeypadFileExist("H") ||
                !KeypadFileExist("Hashtag") || !KeypadFileExist("Lambda") || !KeypadFileExist("Lightning") ||
                !KeypadFileExist("N") || !KeypadFileExist("O") || !KeypadFileExist("Omega") ||
        ...
        static bool FileExists(String name)
        {
            if (!File.Exists(name))
            { 
                MessageBox.Show($"Unable to find {name}. Redownload bot and try again", "File Missing", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
        ...
        static bool DirectoryExists(String name)
        {
            ...
            {
                MessageBox.Show($"Unable to find {name}. Redownload bot and try again", "Directory Missing", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
