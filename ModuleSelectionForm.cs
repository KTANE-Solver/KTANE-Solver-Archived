...
namespace KTANE_Solver
{
    ...
    public partial class ModuleSelectionForm : Form
    {
        ...
        private void SetUpModuleComboBox()
        {
            ...
            String[] modules = new String[] {"Adventure Game", "Adjacent Letters", "Binary Puzzle", "Cheap Checkout", "Chess", "Color Math", "Complicated Wires", "FizzBuzz", "Ice Cream", "Keypad", "Logic", "Maze", "Murder", "Number Pad", "Poker", "Silly Slots", "Who's on First", "Wires", "Word Search"};
